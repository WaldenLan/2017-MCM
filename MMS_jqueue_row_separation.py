    ...
    while True:
        ...
        if state is True:
            ...
            if stage_B == -1:
                ...
                mu_mili = data_generator(mean_A + 2, 1, single=1)
                mu_x_ray = data_generator(stage_B + 1.5, 1, single=1)
                mu_tagtime = 0
...
def airport(arrival_list_precheck, arrival_list_regular, num_hour, time_limit, total_passenger, cnt_officer_precheck, cnt_officer_regular, cnt_pane_precheck, ratio_regular_over_precheck, mean_A, mean_C, mean_D, p_unsafe_rate_precheck, p_unsafe_rate_regular, Milimeter_scan_time, X_ray_scan_time, cnt_milimeter, cnt_x_ray, threshold, cnt_extra_officer_precheck, cnt_extra_officer_regular, cnt_extra_pane_precheck, tagtime_per_box):
    # The outer function to run the simulation
    # arrival_list_precheck:
    # [[], [], ...]:    [precheck_officer_1, ..._2, ......] each precheck_officer corresponds to an arrival list
    clock = 0
...
def overall_mean_variance(iteration, TSA_precheck_arrival_time, Regular_arrival_time, num_flight, flight_gap_time, total_passenger, p_precheck_rate, k_average_box_precheck, k_average_box_regular, cnt_officer_precheck, cnt_officer_regular, num_hour, time_limit, cnt_pane_precheck, ratio_regular_over_precheck, mean_A, mean_C, mean_D, p_unsafe_rate_precheck, p_unsafe_rate_regular, Milimeter_scan_time, X_ray_scan_time, cnt_milimeter, cnt_x_ray, norm_mean, norm_std_dev, cnt_extra_officer_precheck, cnt_extra_officer_regular, cnt_extra_pane_precheck, tagtime_per_box):
    mean_list = []
    variance_list = []
    ttt_list = []
    ...
    for i in range(iteration):
        ...
        result_list, ttt = airport(arrival_list_precheck, arrival_list_regular, num_hour, time_limit, total_passenger,
                              ...
                              cnt_extra_officer_regular, cnt_extra_pane_precheck, tagtime_per_box)
